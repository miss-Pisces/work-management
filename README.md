...
打包产物 `WorkManagement-Setup-1.0.3-win7.exe` 将生成在 `release/` 目录下。已构建的 Win7 安装包可在 [Releases](https://github.com/MissPisces/work-management/releases/tag/v1.0.3) 页面直接下载，无需自行编译。
...
| 版本 | 日期 | 说明 |
|------|------|------|
| [v1.0.3](https://github.com/MissPisces/work-management/releases/tag/v1.0.3) | 2026-08-24 | 热修复：补录手动日志后行动日标记与本月工作状态即时更新 |
